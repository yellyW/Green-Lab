...
def main():
    ...
    monkey_device.touch(850, 150, MonkeyDevice.DOWN_AND_UP)
    ...
    monkey_device.touch(400, 400, MonkeyDevice.DOWN_AND_UP)
    MonkeyRunner.sleep(1)
    ...
    # Show the details
    monkey_device.touch(1010, 760, MonkeyDevice.DOWN_AND_UP)
    ...
    monkey_device.touch(1020, 600, MonkeyDevice.DOWN_AND_UP)
    MonkeyRunner.sleep(1)
    monkey_device.touch(1020, 600, MonkeyDevice.DOWN_AND_UP)
    MonkeyRunner.sleep(1)
